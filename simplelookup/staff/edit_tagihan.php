...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE daftar_tagihan SET no_tagihan=%s, keterangan=%s, aktif=%s WHERE idtagihan=%s",
...
$colname_edit = "-1";
if (isset($_GET['idtagihan'])) {
  $colname_edit = $_GET['idtagihan'];
}
mysql_select_db($database_local, $local);
$query_edit = sprintf("SELECT * FROM daftar_tagihan WHERE idtagihan = %s", GetSQLValueString($colname_edit, "int"));
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><?php echo $row_edit['idtagihan']; ?></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">No_tagihan:</td>
      <td><input type="text" name="no_tagihan" value="<?php echo htmlentities($row_edit['no_tagihan'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
  ...
  <input type="hidden" name="idtagihan" value="<?php echo $row_edit['idtagihan']; ?>" />
</form>
<p>&nbsp;</p>
</body>
</html>
