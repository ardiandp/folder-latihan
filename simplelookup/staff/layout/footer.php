...
<script src="../storage/AdminLTE/plugins/jquery/jquery.min.js"></script>   <!-- yang asli sementara dimatikan dulu -->
<!-- Bootstrap -->
...
<script src="../storage/AdminLTE/plugins/datatables-buttons/js/dataTables.buttons.min.js"></script>
<script src="../storage/AdminLTE/plugins/datatables-buttons/js/buttons.bootstrap4.min.js"></script>
<script src="../storage/AdminLTE/plugins/jszip/jszip.min.js"></script>
<script src="../storage/AdminLTE/plugins/pdfmake/pdfmake.min.js"></script>
<script src="../storage/AdminLTE/plugins/pdfmake/vfs_fonts.js"></script>
<script src="../storage/AdminLTE/plugins/datatables-buttons/js/buttons.html5.min.js"></script>
<script src="../storage/AdminLTE/plugins/datatables-buttons/js/buttons.print.min.js"></script>
<script src="../storage/AdminLTE/plugins/datatables-buttons/js/buttons.colVis.min.js"></script>
