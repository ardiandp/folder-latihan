...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO bpjs_bu (idbpjs, nik, no_akun, nama, no_va, hub_keluarga, terdaftar, aktif, parent, karyawan, kelas, biaya) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $Result1 = mysql_query($insertSQL, $local) or die(mysql_error());
   echo "<script>alert('Data tersimpan'); document.location='?page=bpjsbu' </script>";
}
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td><input type="radio" name="aktif" id="aktif" value="Y" />Ya
      <label for="aktif"></label> <input type="radio" name="aktif" id="aktif" value="N" />Tidak
      <label for="aktif"></label></td>
    </tr>
    <tr valign="baseline">
...
do {  
?>
        <option value="<?php echo $row_parent['nik']?>" ><?php echo $row_parent['nama']?></option>
        <?php
