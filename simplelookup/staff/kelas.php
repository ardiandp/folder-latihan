...
$query_Recordset1 = "SELECT kelas.*, guru.`nama_lengkap` FROM kelas,guru WHERE kelas.`wali`=guru.`nip`";
...
<a href="?page=add_kelas">Tambah Kelas </a>
<body>
<table border="1">
  <tr>
    <td>idkelas</td>
  ...
  <?php do { ?>
    <tr>
      <td><?php echo $row_Recordset1['idkelas']; ?></td>
      <td><?php echo $row_Recordset1['kelas']; ?></td>
      <td><?php echo $row_Recordset1['wali']; ?></td>
