              ...
              <div class="card-body">
                ...
                <div class="col-4">
                   <label for="exampleInputPassword1">Nama Vendor</label>
                    <input type="text" name="nama_vendor" value="" class="form-control" placeholder="Kode karyawan">
                  </div>
                  <div class="col-4">
                   <label for="exampleInputPassword1">Nama PIC</label>
                    <input type="text" name="nama_cp" class="form-control" placeholder="Masukan NIK">
                  </div>
                  <div class="col-4">
